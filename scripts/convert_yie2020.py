...
html_path=os.path.join(root,'originals','yie2020.html')
if not os.path.exists(html_path):
    print('originals/yie2020.html not found',file=sys.stderr); sys.exit(1)
...
article_html=article_html.replace('./yie2020_files/','./')
...
fm = []
fm.append('+++')
fm.append('title = "The Year in Ethereum 2020"')
fm.append('date = 2021-01-20T00:00:00')
fm.append('description = "The Year in Ethereum 2020"')
fm.append('tags = ["year-in-ethereum", "ethereum"]')
fm.append('draft = false')
if cover:
    fm.append('\n[params.cover]')
    fm.append(f'image = "{cover}"')
    fm.append('alt = "The Year in Ethereum 2020"')
    fm.append('caption = "The Year in Ethereum 2020"')
fm.append('+++\n')
content='\n'.join(fm)+article_html+"\n"
out_dir=os.path.join(root,'content','posts','YIE2020')
...
assets_src=os.path.join(root,'originals','yie2020_files')
if os.path.exists(assets_src):
    ...
    print('assets folder not found; remember to copy originals/yie2020_files into',out_dir)
print('Done')
